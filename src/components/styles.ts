...
export const SEC_HDR = "flex items-center justify-between gap-3 mb-[18px]";

export const EYEBROW = "mb-2 uppercase tracking-[0.16em] text-xs text-[#7dc9ff]";
...
export const PRIMARY_BTN = `${BTN} w-full min-h-12 px-4 rounded-2xl bg-gradient-to-br from-[#6d7dff] to-[#55c5ff] text-[#05111f] font-bold`;

export const SECONDARY_BTN = `${BTN} min-h-[46px] px-4 rounded-2xl text-[#eaf3ff] bg-[rgba(86,133,255,0.16)]`;

export const GHOST_BTN = `${BTN} min-h-[46px] px-4 rounded-2xl text-[#eaf3ff] bg-[rgba(255,255,255,0.06)]`;

export const DANGER_BTN = `${BTN} w-full min-h-12 rounded-2xl bg-[rgba(255,60,60,0.16)] text-[#ff9e9e] font-bold hover:bg-[rgba(255,60,60,0.28)]`;

const BADGE = "inline-flex items-center justify-center px-3 py-1.5 rounded-2xl text-[0.85rem]";
...
export const NAV_LINK = "flex items-center gap-3 px-4 py-3 rounded-2xl text-[#c7d3f7] transition-colors hover:bg-[rgba(86,133,255,0.12)]";

export const NAV_LINK_ACTIVE = "flex items-center gap-3 px-4 py-3 rounded-2xl text-white bg-[rgba(86,133,255,0.18)]";
